...
/*
 * `answer` feeds the FAQPage JSON-LD and must stay a clean, tax-free price.
 * `displayAnswer`, when present, is what customers actually read on the page.
 */
const cityDeepFaqs: Record<
  string,
  { question: string; answer: string; displayAnswer?: string }[]
> = {
  frisco: [
    { question: "How much does pool cleaning cost in Frisco?", answer: "Weekly pool service in Frisco starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo. Both plans include water testing, chemical adjustment, surface cleaning, and equipment inspection every visit.", displayAnswer: "Weekly pool service in Frisco starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax. Both plans include water testing, chemical adjustment, surface cleaning, and equipment inspection every visit." },
  ...
  plano: [
    { question: "How much does pool service cost in Plano?", answer: "Weekly pool service in Plano starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in Plano starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
  ...
  mckinney: [
    { question: "How much does pool cleaning cost in McKinney?", answer: "Weekly pool service in McKinney starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in McKinney starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
  ...
  allen: [
    { question: "How much does pool service cost in Allen?", answer: "Weekly pool service in Allen starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in Allen starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
  ...
  murphy: [
    { question: "How much does pool cleaning cost in Murphy?", answer: "Weekly pool service in Murphy starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in Murphy starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
  ...
  "the-colony": [
    { question: "How much does pool service cost in The Colony?", answer: "Weekly pool service in The Colony starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in The Colony starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
  ...
  prosper: [
    { question: "How much does pool cleaning cost in Prosper?", answer: "Weekly pool service in Prosper starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in Prosper starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
  ...
  parker: [
    { question: "How much does pool service cost in Parker?", answer: "Weekly pool service in Parker starts at $179/mo with all chemicals included. Bi-weekly starts at $139/mo.", displayAnswer: "Weekly pool service in Parker starts at $179/mo + tax with all chemicals included. Bi-weekly starts at $139/mo + tax." },
